...
import AddAssetType from './../ModalPopUp/AddDriverForm';
import io from 'socket.io-client';
    ...
    return(
        <div className="content-wrapper">
            <section className="content-header">
              ...
              <h1 className="float-left"> Asset Type Master </h1>
              <div className="import-tools-block">
               
                <li>
                </li>
                <li>
                  <a className="btn btn-info" onClick={(e)=>this.openAddDriverForm()}>Add Asset Type</a>
                </li>
              </div>
            </section>
                  ...
                  <div className="box">
                    <div className="box-header">
                      <div className="col-xs-8">
                        <h3 className="box-title">Asset Type</h3>
                      </div>
